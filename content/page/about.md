...
Сайт проекта сделан на генераторе статических сайтов [Hugo](https://gohugo.io/) c темой [Bleak](https://github.com/zenithar/hugo-theme-bleak). Контент хранится в репозитории и редактируется напрямую в markdown-файлах.

Подзаголовком служит название песни московской панк-рок группы [Cretin Boys](https://vk.com/cretinboys) — «Я люблю свои пластинки больше, чем тебя». Собирать контент мне помогает ответственный фрилансер, контактами которой поделюсь с желающими.
